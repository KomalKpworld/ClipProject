...
export declare type DocumentSnapshot<T> = DocumentSnapshotExists | DocumentSnapshotDoesNotExist;
export interface QueryDocumentSnapshot extends firebase.firestore.QueryDocumentSnapshot {
    data(options?: SnapshotOptions) ;
}
